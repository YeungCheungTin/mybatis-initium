...
public class Context extends PropertyHolder {
    ...
    private BusinessModelGeneratorConfiguration businessModelGeneratorConfiguration;
    ...
    public BusinessModelGeneratorConfiguration getBusinessModelGeneratorConfiguration() {
        return businessModelGeneratorConfiguration;
    }
    ...
    public void validate(List<String> errors) {
        ...
        if (businessModelGeneratorConfiguration != null) {
            businessModelGeneratorConfiguration.validate(errors, id);
        }
    ...
    public void setBusinessModelGeneratorConfiguration(BusinessModelGeneratorConfiguration businessModelGeneratorConfiguration) {
        this.businessModelGeneratorConfiguration = businessModelGeneratorConfiguration;
    }
    ...
    public XmlElement toXmlElement() {
        ...
        if (businessModelGeneratorConfiguration != null) {
            xmlElement.addElement(businessModelGeneratorConfiguration.toXmlElement());
        }
    ...
    public void addProperty(String name, String value) {
        ...
        } else if (PropertyRegistry.CONTEXT_AUTHOR.equals(name)) {
            author = value;
        }
    }
    ...
    public int getIntrospectionSteps() {
        return 1 + tableConfigurations.size();
    }
