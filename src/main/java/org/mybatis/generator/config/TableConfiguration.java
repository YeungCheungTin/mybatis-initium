...
public class TableConfiguration extends PropertyHolder {
    ...
    public boolean isDefineCandidateKey() {
        return updateConfiguration != null && updateConfiguration.getCandidateKeys() != null && !updateConfiguration.getCandidateKeys().isEmpty();
    }
