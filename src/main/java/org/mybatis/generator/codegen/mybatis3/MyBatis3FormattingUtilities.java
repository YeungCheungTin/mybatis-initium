...
public class MyBatis3FormattingUtilities {
    ...
    public static String getEscapedColumnName(IntrospectedColumn introspectedColumn) {
        ...
        return sb.toString();
        //return escapeStringFromSqlReservedWords(sb.toString());
    }
    ...
    private static String escapeStringForMyBatis3(String s) {
     ...
     * 在数据库保留字前后加上`
     */
    private static String escapeStringFromSqlReservedWords(String word) {
